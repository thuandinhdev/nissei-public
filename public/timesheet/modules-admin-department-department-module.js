...
/* harmony import */ var _core_helpers_app_helper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../core/helpers/app.helper */ "./src/app/core/helpers/app.helper.ts");
...
var DepartmentDetailComponent = /** @class */ (function () {
    function DepartmentDetailComponent(translate, route, router, http, toastr, departmentService, authenticationService) {
        var _this = this;
        this.translate = translate;
        this.route = route;
        this.router = router;
    ...
    DepartmentDetailComponent.prototype.getDepartments = function (departmentId, roleId) {
        ...
        this.departmentService.getDepartmentDetail(departmentId, roleId)
            ...
            setTimeout(function () {
                Object(_core_helpers_app_helper__WEBPACK_IMPORTED_MODULE_8__["loadDepartmentMenu"])();
            });
        });
    };
    ...
    DepartmentDetailComponent.prototype.saveDepartment = function () {
        ...
        this.departmentService.updateDepartmentDetail(this.departmentId, this.roleId, { 'menu': lodash__WEBPACK_IMPORTED_MODULE_9__["union"](menu, childMenu), 'submenu': finalSubmenus }).subscribe(function (data) {
            _this.toastr.success(_this.translate.instant('departments.messages.update'), _this.translate.instant('departments.title'));
...
/* harmony import */ var _components_create_department_modal_create_department_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../components/create-department-modal/create-department-modal.component */ "./src/app/modules/admin/department/components/create-department-modal/create-department-modal.component.ts");
/* harmony import */ var _components_edit_department_modal_edit_department_modal_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../components/edit-department-modal/edit-department-modal.component */ "./src/app/modules/admin/department/components/edit-department-modal/edit-department-modal.component.ts");
...
var DepartmentComponent = /** @class */ (function () {
    function DepartmentComponent(translate, http, modalService, toastr, departmentService, authenticationService) {
        var _this = this;
        this.translate = translate;
        this.http = http;
    ...
    DepartmentComponent.prototype.openDepartmentCreateModal = function () {
        var _this = this;
        this.modalRef = this.modalService.show(_components_create_department_modal_create_department_modal_component__WEBPACK_IMPORTED_MODULE_9__["CreateDepartmentModalComponent"], this.modalConfigs);
    ...
    DepartmentComponent.prototype.openDepartmentEditModal = function (department) {
        ...
        this.modalRef = this.modalService.show(_components_edit_department_modal_edit_department_modal_component__WEBPACK_IMPORTED_MODULE_10__["EditDepartmentModalComponent"], modalConfig);
        this.modalRef.content.onClose.subscribe(function (result) {
            _this.getDepartments();
        });
    };
