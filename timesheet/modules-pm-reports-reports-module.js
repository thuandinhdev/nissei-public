...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/pm/reports/components/sales-reports/sales-reports.component.html":
/*!********************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/modules/pm/reports/components/sales-reports/sales-reports.component.html ***!
  \********************************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- Card header -->\r\n<div class=\"pl-0 pr-0 border-bottom\">\r\n\t<h4 class=\"main-title mt-2\"><span>{{'reports.headings.sales_report' | translate}}</span></h4>\r\n</div>\r\n<!-- Card body -->\r\n<div class=\"card-body pt-3 overflow-x-scroll overflow-y-hidden\">\r\n\t<!-- Filter buttons -->\r\n\t<form [formGroup]=\"filterForm\" (ngSubmit)=\"onSubmit()\">\r\n\t\t<div class=\"row d-flex\" *ngIf=\"isPageLoaded\">\r\n\t\t\t<div class=\"col-sm-2\">\r\n\t\t\t\t<div class=\"form-group\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && filterControl.range.errors }\">\r\n\t\t\t\t\t<label for=\"range\" class=\"sr-only\"></label>\r\n\t\t\t\t\t<ng-select [searchable]=\"true\"\r\n\t\t\t\t\t\t[clearable]=\"false\"\r\n\t\t\t\t\t\t[items]=\"range\"\r\n\t\t\t\t\t\t[selectOnTab]=\"true\"\r\n\t\t\t\t\t\t[multiple]=\"false\"\r\n\t\t\t\t\t\tbindLabel=\"label\"\r\n\t\t\t\t\t\tbindValue=\"id\"\r\n\t\t\t\t\t\tlabelForId=\"range\"\r\n\t\t\t\t\t\tformControlName=\"range\"\r\n\t\t\t\t\t\t(change)=\"rangeChange($event)\">\r\n\t\t\t\t\t</ng-select>\r\n\t\t\t\t\t<div *ngIf=\"isFormSubmitted && filterControl.range.errors\" class=\"invalid-feedback\">\r\n\t\t\t\t\t\t<div *ngIf=\"filterControl.range.errors.required\">{{'reports.filter.error_messages.message1' | translate }}</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"col-sm-3\" *ngIf=\"filterControl.range.value == 'period'\">\r\n\t\t\t\t<div class=\"form-group\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && filterControl.period_from.errors }\">\r\n\t\t\t\t\t<label for=\"period_from\" class=\"sr-only\"></label>\r\n\t\t\t\t\t<div class=\"position-relative has-icon-left\">\r\n\t\t\t\t\t\t<input class=\"form-control\" #dp1=\"bsDatepicker\" bsDatepicker [bsConfig]=\"datepickerConfig\" (bsValueChange)=\"periodFromDateChange($event)\" formControlName=\"period_from\" id=\"period_from\" placeholder=\"{{'reports.filter.placeholders.placeholder1' | translate }}\" />\r\n\t\t\t\t\t\t<div class=\"form-control-position\"><i class=\"ft-calendar\"></i></div>\r\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && filterControl.period_from.errors\" class=\"invalid-feedback\">\r\n\t\t\t\t\t\t\t<div *ngIf=\"filterControl.period_from.errors\">{{'reports.filter.error_messages.message2' | translate }}</div>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"col-sm-3\" *ngIf=\"filterControl.range.value == 'period'\">\r\n\t\t\t\t<div class=\"form-group\" [ngClass]=\"{ 'is-invalid': isFormSubmitted && filterControl.period_to.errors }\">\r\n\t\t\t\t\t<label for=\"period_to\" class=\"sr-only\"></label>\r\n\t\t\t\t\t<div class=\"position-relative has-icon-left\">\r\n\t\t\t\t\t\t<input class=\"form-control\" #dp2=\"bsDatepicker\" bsDatepicker [bsConfig]=\"datepickerConfig\" [minDate]=\"filterForm.get('period_from').value\" formControlName=\"period_to\" id=\"period_to\" placeholder=\"{{'reports.filter.placeholders.placeholder2' | translate }}\" />\r\n\t\t\t\t\t\t<div class=\"form-control-position\"><i class=\"ft-calendar\"></i></div>\r\n\t\t\t\t\t\t<div *ngIf=\"isFormSubmitted && filterControl.period_to.errors\" class=\"invalid-feedback\">\r\n\t\t\t\t\t\t\t<div *ngIf=\"filterControl.period_to.errors\">{{'reports.filter.error_messages.message3' | translate }}</div>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"col-sm-3\">\r\n\t\t\t\t<div class=\"form-group\">\r\n\t\t\t\t\t<label for=\"status\" class=\"sr-only\"></label>\r\n\t\t\t\t\t<ng-select [searchable]=\"true\"\r\n\t\t\t\t\t\t[items]=\"('invoices.status' | translate)\"\r\n\t\t\t\t\t\t[selectOnTab]=\"true\"\r\n\t\t\t\t\t\t[multiple]=\"true\"\r\n\t\t\t\t\t\t[selectableGroup]=\"false\"\r\n\t\t\t\t\t\tbindLabel=\"label\"\r\n\t\t\t\t\t\tbindValue=\"id\"\r\n\t\t\t\t\t\tlabelForId=\"status\"\r\n\t\t\t\t\t\tformControlName=\"status\"\r\n\t\t\t\t\t\tplaceholder=\"{{'invoices.create.placeholders.placeholder6' | translate }}\"\r\n\t\t\t\t\t\t(change)=\"onSubmit()\">\r\n\t\t\t\t\t</ng-select>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"col-md-3\">\r\n\t\t\t\t<div class=\"form-group\">\r\n\t\t\t\t\t<label class=\"form-check checkbox-container\">\r\n\t\t\t\t\t\t<input class=\"form-check-input\" type=\"checkbox\" formControlName=\"is_overdue\" id=\"is_overdue\" (change)=\"onSubmit()\">\r\n\t\t\t\t\t\t<label></label>\r\n\t\t\t\t\t\t<span class=\"checkbox-checkmark\"></span>\r\n\t\t\t\t\t</label>\r\n\t\t\t\t\t<label for=\"is_overdue\">{{'common.overdue' | translate }}</label>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"col text-left btn_apply d-none\">\r\n\t\t\t\t<button type=\"submit\" class=\"btn btn-submit btn-sm mb-0\">{{'common.apply' | translate}}</button>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</form>\r\n\t<!-- Sales Report List Datatable -->\r\n\t<div class=\"row\">\r\n\t\t<div class=\"col-lg-12 mb-3\">\r\n\t\t\t<div\r\n\t\t\t\tclass=\"table-responsive-xs table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl\">\r\n\t\t\t\t<table datatable [dtOptions]=\"dtOptions\" [dtTrigger]=\"dtTrigger\"\r\n\t\t\t\t\tclass=\"table table-bordered table-hover b4-datatable\" id=\"sales_report_table\">\r\n\t\t\t\t\t<thead>\r\n\t\t\t\t\t\t<tr class=\"display_all\">\r\n\t\t\t\t\t\t\t<th>{{'invoices.columns.invoice_number' | translate}} #</th>\r\n\t\t\t\t\t\t\t<th>{{'invoices.columns.customer' | translate}}</th>\r\n\t\t\t\t\t\t\t<th>{{'invoices.columns.invoice_date' | translate}}</th>\r\n\t\t\t\t\t\t\t<th>{{'invoices.columns.due_date' | translate}}</th>\r\n\t\t\t\t\t\t\t<th>{{'invoices.columns.total_amount' | translate}}</th>\r\n\t\t\t\t\t\t\t<th>{{'invoices.create.fields.total_amount_due' | translate}}</th>\r\n\t\t\t\t\t\t\t<th>{{'invoices.columns.status' | translate}}</th>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</thead>\r\n\t\t\t\t\t<tbody *ngIf=\"invoices?.length != 0\">\r\n\t\t\t\t\t\t<tr *ngFor=\"let invoice of invoices\">\r\n\t\t\t\t\t\t\t<td>{{invoice.invoice_number}}</td>\r\n\t\t\t\t\t\t\t<td>{{invoice.client_firstname}} {{invoice.client_lastname}}</td>\r\n\t\t\t\t\t\t\t<td>{{invoice.invoice_date | dateTimeFormatFilter: loginUser.settings.date_format}}</td>\r\n\t\t\t\t\t\t\t<td>{{invoice.due_date | dateTimeFormatFilter: loginUser.settings.date_format}}</td>\r\n\t\t\t\t\t\t\t<td>{{invoice.total_amount | number : '1.2-2'}}</td>\r\n\t\t\t\t\t\t\t<td>{{invoice.total_due_amount | number : '1.2-2'}}</td>\r\n\t\t\t\t\t\t\t<td class=\"budges-status\">\r\n\t\t\t\t\t\t\t\t<ng-container *ngFor=\"let status of ('invoices.status' | translate)\">\r\n\t\t\t\t\t\t\t\t\t<span class=\"{{status.class}}\" *ngIf=\"status.id == invoice.status\">{{status.label}}</span>\r\n\t\t\t\t\t\t\t\t</ng-container>\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</tbody>\r\n\t\t\t\t\t<tbody *ngIf=\"invoices?.length != 0\">\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td></td>\r\n\t\t\t\t\t\t\t<td></td>\r\n\t\t\t\t\t\t\t<td></td>\r\n\t\t\t\t\t\t\t<td></td>\r\n\t\t\t\t\t\t\t<td><b>{{loginUser.currency.symbol}} {{total.total_amount}}</b></td>\r\n\t\t\t\t\t\t\t<td><b>{{loginUser.currency.symbol}} {{total.total_due_amount}}</b></td>\r\n\t\t\t\t\t\t\t<td></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</tbody>\r\n\t\t\t\t\t<tfoot>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th><input type=\"text\" class=\"form-control\" placeholder=\"{{'invoices.columns.invoice_number' | translate}}\" name=\"invoice_number\" /></th>\r\n\t\t\t\t\t\t\t<th><input type=\"text\" class=\"form-control\" placeholder=\"{{'invoices.columns.customer' | translate}}\" name=\"customer\" /></th>\r\n\t\t\t\t\t\t\t<th><input type=\"text\" class=\"form-control\" placeholder=\"{{'invoices.columns.invoice_date' | translate}}\" name=\"invoice_date\" /></th>\r\n\t\t\t\t\t\t\t<th><input type=\"text\" class=\"form-control\" placeholder=\"{{'invoices.columns.due_date' | translate}}\" name=\"due_date\" /></th>\r\n\t\t\t\t\t\t\t<th><input type=\"text\" class=\"form-control\" placeholder=\"{{'invoices.columns.total_amount' | translate}}\" name=\"total_amount\" /></th>\r\n\t\t\t\t\t\t\t<th><input type=\"text\" class=\"form-control\" placeholder=\"{{'invoices.create.fields.total_amount_due' | translate}}\" name=\"total_due_amount\" /></th>\r\n\t\t\t\t\t\t\t<th><input type=\"text\" class=\"form-control\" placeholder=\"{{'invoices.columns.status' | translate}}\" name=\"status\" /></th>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</tfoot>\r\n\t\t\t\t\t<tfoot *ngIf=\"invoices?.length == 0\" class=\"tfoot_dt\">\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td colspan=\"7\" class=\"text-center\">\r\n\t\t\t\t\t\t\t\t<img src=\"assets/img/norecord-img.png\" width=\"50\">\r\n\t\t\t\t\t\t\t\t<p class=\"mt-1\">{{ 'common.empty_message.invoices' | translate }}</p>\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</tfoot>\r\n\t\t\t\t</table>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/***/ "./src/app/modules/pm/reports/components/sales-reports/sales-reports.component.scss":
/*!******************************************************************************************!*\
  !*** ./src/app/modules/pm/reports/components/sales-reports/sales-reports.component.scss ***!
  \******************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvcG0vcmVwb3J0cy9jb21wb25lbnRzL3NhbGVzLXJlcG9ydHMvc2FsZXMtcmVwb3J0cy5jb21wb25lbnQuc2NzcyJ9 */");

/***/ }),

/***/ "./src/app/modules/pm/reports/components/sales-reports/sales-reports.component.ts":
/*!****************************************************************************************!*\
  !*** ./src/app/modules/pm/reports/components/sales-reports/sales-reports.component.ts ***!
  \****************************************************************************************/
...
var SalesReportsComponent = /** @class */ (function () {
    function SalesReportsComponent(translate, formBuilder, http, authenticationService, exportAsService) {
        var _this = this;
        this.translate = translate;
        ...
        this.exportAsConfig = {
            type: 'pdf',
            elementIdOrContent: 'sales_report_table',
        };
    ...
    SalesReportsComponent.prototype.loadForms = function () {
    ...
    SalesReportsComponent.prototype.rangeChange = function (event) {
        var fromControl = this.filterForm.get('period_from');
        var toControl = this.filterForm.get('period_to');
        if (event.id === 'period') {
    ...
    SalesReportsComponent.prototype.periodFromDateChange = function (event) {
        this.filterForm.patchValue({ period_to: event });
    };
    Object.defineProperty(SalesReportsComponent.prototype, "filterControl", {
        get: function () { return this.filterForm.controls; },
        enumerable: true,
        configurable: true
    });
    SalesReportsComponent.prototype.onSubmit = function () {
    ...
    SalesReportsComponent.prototype.loadDatatable = function () {
        var _this = this;
        var that = this;
        this.dtOptions = {
            pagingType: 'full_numbers',
            ...
            buttons: [{
                    extend: 'excel',
                    title: this.translate.instant('reports.headings.sales_report'),
                    className: "btn btn-datatable-gredient",
                    action: function (e, dt, node, config) {
                        that.exportFiles('xlsx');
                    }
            ...
            ajax: function (dataTablesParameters, callback) {
                dataTablesParameters.range = _this.filterForm.value.range;
                dataTablesParameters.period_from = _this.filterForm.value.period_from;
                dataTablesParameters.period_to = _this.filterForm.value.period_to;
                dataTablesParameters.status = _this.filterForm.value.status;
                dataTablesParameters.is_overdue = _this.filterForm.value.is_overdue;
                _this.http
                    .post(_this.apiUrl + '/api/sales/report', dataTablesParameters, {})
                    .subscribe(function (resp) {
                    _this.invoices = resp.data;
                    _this.total = resp;
                    _this.total = _this.total.total;
                    _this.isPageLoaded = true;
                    callback({
                        recordsTotal: resp.recordsTotal,
                        recordsFiltered: resp.recordsFiltered,
    ...
    SalesReportsComponent.prototype.exportFiles = function (type) {
        this.exportAsConfig.type = type;
        this.exportAsService.save(this.exportAsConfig, this.translate.instant('reports.headings.sales_report')).subscribe(function () { });
    };
    SalesReportsComponent.prototype.ngOnDestroy = function () {
        this.dtTrigger.unsubscribe();
    };
    SalesReportsComponent.prototype.rerender = function () {
        var _this = this;
        this.dtElement.dtInstance.then(function (dtInstance) {
            dtInstance.destroy();
            setTimeout(function () {
    ...
    SalesReportsComponent.prototype.setMessage = function () {
    ...
    SalesReportsComponent.prototype.ngAfterViewInit = function () {
        this.dtTrigger.next();
        this.dtElement.dtInstance.then(function (dtInstance) {
            dtInstance.columns().every(function () {
                var that = this;
    ...
    SalesReportsComponent.ctorParameters = function () { return [
    ...
    ], SalesReportsComponent.prototype, "dtElement", void 0);
    SalesReportsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-sales-reports',
            template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./sales-reports.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/pm/reports/components/sales-reports/sales-reports.component.html")).default,
            styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./sales-reports.component.scss */ "./src/app/modules/pm/reports/components/sales-reports/sales-reports.component.scss")).default]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("::ng-deep .odd {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _components_sales_reports_sales_reports_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/sales-reports/sales-reports.component */ "./src/app/modules/pm/reports/components/sales-reports/sales-reports.component.ts");
    ...
    ReportsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_sales_reports_sales_reports_component__WEBPACK_IMPORTED_MODULE_18__["SalesReportsComponent"]
            ],
            imports: [
